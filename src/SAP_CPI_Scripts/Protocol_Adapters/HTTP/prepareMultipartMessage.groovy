...
//        }
    ...
    multipartEntityBuilder.addTextBody("quickExpenseRequest", concurBody, ContentType.APPLICATION_JSON)

    // Add the binary attachment as a part of the multipart message
    multipartEntityBuilder.addBinaryBody("fileContent", attachmentBinaryData, ContentType.create(fileType), fileName)
